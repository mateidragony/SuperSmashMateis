...
public class PlayerOld extends Actor {
    ...
    public PlayerOld(double x, double y, int w, int h, String team) {
        super(x,y,w,h);
    ...
    public void animateBoss(){
        ...
        if(bossAttackTimer < 0){
            HomingShot myProj = new HomingShot((int)getX()+getW()/2,(int)getY()+getH()/4-10,
                    getDirection(),getTeam(), 1,false,false);
            pList.add(myProj);
            if(myRain != null){
                if(myRain.getY()>700)
                    doKAttack();
    ...
    public static void initImages(){
        ...
        myInGameImageLists.add(initMateiImages(toolkit));
        myInGameImageLists.add(initUmerImages(toolkit));
        myInGameImageLists.add(initAdamImages(toolkit));
        myInGameImageLists.add(initJackImages(toolkit));
        myInGameImageLists.add(initKaushalImages(toolkit));
        myInGameImageLists.add(initSalomeImages(toolkit));
        myInGameImageLists.add(initSpockImages(toolkit));
        myInGameImageLists.add(initLisonImages(toolkit));
        myInGameImageLists.add(initObamaImages(toolkit));
        myInGameImageLists.add(initEmiImages(toolkit));
        myInGameImageLists.add(initLawrenceImages(toolkit));
        myInGameImageLists.add(initNeelImages(toolkit));
    ...
    public static ArrayList<Image> initMateiImages(Poolkit toolkit){
    ...
    public static ArrayList<Image> initUmerImages(Poolkit toolkit){
    ...
    public static ArrayList<Image> initAdamImages(Poolkit toolkit){
    ...
    public static ArrayList<Image> initJackImages(Poolkit toolkit){
    ...
    public static ArrayList<Image> initKaushalImages(Poolkit toolkit){
    ...
    public static ArrayList<Image> initSalomeImages(Poolkit toolkit){
    ...
    public static ArrayList<Image> initSpockImages(Poolkit toolkit){
    ...
    public static ArrayList<Image> initLisonImages(Poolkit toolkit){
    ...
    public static ArrayList<Image> initObamaImages(Poolkit toolkit){
    ...
    public static ArrayList<Image> initEmiImages(Poolkit toolkit){
    ...
    public static ArrayList<Image> initLawrenceImages(Poolkit toolkit){
    ...
    public static ArrayList<Image> initNeelImages(Poolkit toolkit){
...
//        isHealing = false;
    ...
    public void animateAndDrawJAttack(ArrayList<PlayerOld> playerList, ArrayList<Projectile> enemyPList,
                                      PlayerOld enemy, Graphics g, ImageObserver io){
//        if(myPunch!=null){
...
//        }
    ...
    public void animateAndDrawKAttack(ArrayList<PlayerOld> players, PlayerOld enemy,
...
//        }
    ...
    public void animateAndDrawLAttack(ArrayList<PlayerOld> players, PlayerOld enemy,
                                      Graphics g, ImageObserver io){
...
//        }
    ...
    public static String pack(PlayerOld me){
...
//        packedPlayersInfo += me.getFlameDuration() + parseChar;
    ...
    public static void unPack(String s, PlayerOld enemy, PlayerOld me){
//
//        if(testPrintTimer < 0){
//            testPrintTimer = 1;
